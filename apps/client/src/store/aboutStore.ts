...
const defaultAboutData: AboutData = {
  heroSection: {
    title: "Stazy - Quản lý khách sạn thông minh",
    description:
  ...
  team: {
    ...
    subtitle: "Những con người tài năng và đam mê tạo nên Stazy",
    members: [],
  },
  values: {
...
const STORAGE_KEY = "hotel-stazy-about-data";
...
const loadDefaultJsonData = async (): Promise<AboutData> => {
  try {
    ...
    console.error(
      "Error loading default JSON data, using hardcoded default:",
      error
    );
