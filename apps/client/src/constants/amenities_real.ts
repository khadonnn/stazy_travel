...
export const ALL_AMENITY_IDS = [
    // 🌐 Cơ bản (gần như bắt buộc)
    'wifi',
    'air-conditioning',
    'bathroom', // thay vì 'private-bathroom'
    'hot-water',
    'tv',
    'laundry', // máy giặt hoặc dịch vụ
    ...
    'extra-bed',
    'balcony',
    'terrace', // nên thêm (sân thượng/sân vườn nhỏ)

    // 🍳 Bếp & Ăn uống
    'kitchen', // đã bao gồm bếp + đồ dùng cơ bản
    'fridge',
    'microwave',
    'coffee-maker', // thay 'coffee-machine' → chuẩn hơn
    'breakfast', // ăn sáng
    ...
    'gym',
    'spa', // nếu có riêng
    'bbq', // thay 'bbq-grill' → ngắn gọn, search nhiều
    'garden', // thay vì 'bbq-grill' + 'scenic-view' → tách riêng
    ...
    // 🚗 Di chuyển & Đậu xe
    'parking', // thay 'free-parking' → "miễn phí" là mặc định kỳ vọng
    'motorbike-parking', // nên thêm (rất quan trọng ở VN!)
    'bike-rental',
    'motorbike-rental',
    'airport-shuttle',

    // 🌄 View & Cảnh quan (tách rõ!)
    'mountain-view',
    'beach-view', // thay 'beach-access' + 'private-beach'
    'sea-view', // nên thêm (biển xa ≠ beach)
    'river-view',
    'lake-view',
    'city-view',
    'garden-view',
    ...
    // 🔐 An toàn
    'cctv',
    'reception-24h', // sửa từ '24h-reception'
