              ...
              <div className="flex flex-col gap-2">
                  {listData.map((item, index) => {
                      ...
                      if (isHotelList) {
                          ...
                          return (
                              <Card key={hotelItem.id} className="flex flex-row items-center justify-between gap-2 p-2">
                                  ...
                                  <div className="flex min-w-0 flex-1 flex-col">
                                      ...
                                      <div className="text-muted-foreground flex items-end justify-between text-xs">
                                          ...
                                          <div className="text-foreground flex items-center gap-1 font-semibold">
                                              <span>⭐ {hotelItem.reviewStart}</span>
                                          </div>
                                      </div>
                                  </div>
                      ...
                      // HIỂN THỊ DANH SÁCH GIAO DỊCH/NGƯỜI DÙNG (recentBookings)
                          ...
                          return (
                              <Card key={userItem.id} className="flex flex-row items-center justify-between gap-2 p-2">
                                  {/* Avatar Khách hàng */}
